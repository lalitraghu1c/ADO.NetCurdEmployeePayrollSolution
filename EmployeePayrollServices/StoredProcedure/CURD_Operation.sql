...
INSERT INTO EmpDetails VALUES ('Sidd', 'Developer', 99000000), ('Lalit', 'JsDeveloper', 98000000), ('Saurav', 'Frontend', 8000000), ('Shubham', 'HR', 7000000);
...
AS BEGIN  
   UPDATE EmpDetails SET @EmpsName = @EmpsName, EmpDept = @EmpsDept, EmpSalary = @EmpsSalary WHERE EmpId = @EmpsId 
END 
